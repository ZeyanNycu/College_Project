...
def find_frequent_itemsets(path, ratio_support, include_support=False):
    transactions = []
...
dataset_path = '/home/lu/桌面/Data_mining/hw1/toy_dataset_and_verification_code/toy_dataset_and_verification_code/T10I6001M.data'
output_path = '/home/lu/桌面/Data_mining/hw1/statics/non-apriori.txt'
#主函数
if __name__ == '__main__':
    ...
    start = time.time()
    frequent_itemsets = find_frequent_itemsets(args.inputFile, ratio_support=args.minSupport, include_support=True)
    result = []
